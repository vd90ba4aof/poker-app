...
report_dir = '/app/data/所有对话/主对话/poker-app-latest/poker_decision_engine_analysis'

# Build report piece by piece to avoid quoting issues
sections = []

sections.append(f"""# 青云扑克App PokerDecisionEngine 策略引擎完整分析报告
...
report_path = '/app/data/所有对话/主对话/poker-app-latest/poker_decision_engine_analysis/poker_decision_engine_report.md'
with open(report_path, 'w', encoding='utf-8') as f:
    f.write(report_content)

print(f"Report written to: {report_path}")
print(f"Size: {len(report_content)} chars, {report_content.count(chr(10))} lines")
