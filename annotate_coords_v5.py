...
elements = {
    ...
    # ===== 下注按钮 - 整体再往下移约150px =====
    "下注100%": [730, 1770, 1080, 1900, "100%下注2,200", (255, 150, 0)],
    "下注75%":  [730, 1915, 1080, 2035, "75%下注1,650",  (255, 150, 0)],
    "下注50%":  [730, 2050, 1080, 2170, "50%下注1,100",  (255, 150, 0)],
    "下注33%":  [730, 2185, 1080, 2305, "33%下注726",    (255, 150, 0)],
    # ===== 底部操作按钮 =====
