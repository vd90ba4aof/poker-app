...
elements = {
    ...
    # ===== 下注按钮 (4个，右侧) - 坐标重新校准 =====
    "下注100%": [730, 1490, 1080, 1620, "100%下注2,200", (255, 150, 0)],
    "下注75%":  [730, 1640, 1080, 1760, "75%下注1,650",  (255, 150, 0)],
    "下注50%":  [730, 1780, 1080, 1900, "50%下注1,100",  (255, 150, 0)],
    "下注33%":  [730, 1920, 1080, 2040, "33%下注726",    (255, 150, 0)],
    # ===== 底部操作按钮 =====
