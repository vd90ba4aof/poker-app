...
elements = {
    ...
    # ===== 下注按钮 - 重新精确定位 =====
    "下注100%": [730, 1650, 1080, 1780, "100%下注2,200", (255, 150, 0)],
    "下注75%":  [730, 1795, 1080, 1915, "75%下注1,650",  (255, 150, 0)],
    "下注50%":  [730, 1930, 1080, 2050, "50%下注1,100",  (255, 150, 0)],
    "下注33%":  [730, 2065, 1080, 2190, "33%下注726",    (255, 150, 0)],
    # ===== 底部操作按钮 =====
    "让牌/弃牌": [20,  2230, 370, 2340, "让牌/弃牌", (255, 150, 0)],
    "让牌":     [390, 2230, 710, 2340, "让牌",      (255, 150, 0)],
    # ===== D(dealer) =====
