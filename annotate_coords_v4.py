...
elements = {
    ...
    # ===== 下注按钮 (4个，右侧) - 再往下移约130px =====
    "下注100%": [730, 1620, 1080, 1750, "100%下注2,200", (255, 150, 0)],
    "下注75%":  [730, 1770, 1080, 1895, "75%下注1,650",  (255, 150, 0)],
    "下注50%":  [730, 1915, 1080, 2040, "50%下注1,100",  (255, 150, 0)],
    "下注33%":  [730, 2060, 1080, 2185, "33%下注726",    (255, 150, 0)],
    # ===== 底部操作按钮 =====
